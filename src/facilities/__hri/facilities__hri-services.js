  ...
  >
    <div className="facilities__section-inner">
      ...
      <p>
        ...
        the A1R hybrid scan head capable of switching between Galvano and Resonant scan modes to
        balance resolution and speed. The A1-DUG-2 multidetector unit simultaneously detects 4
        fluorescence channels with filters to detect DAPI, CFP, GFP, YFP, Red and Far red
        fluorophores. Additionally, a DUT diascopic detector allows transmitted light imaging. Air
        and water- and oil-immersion objectives from 10x to 60x are available for most imaging
        needs. The tunable Chameleon Discovery multiphoton laser permits high-resolution imaging
        of thick specimens including organoids and tissues. The multiphoton excitation is paired
        with a four-channel episcopic ultra-high sensitivity non-descanned detector for optimal
        signal capture. Three multiphoton-specific objectives are available. A Tokai Hit stage top
        incubator system allows live imaging using any modality.
      </p>
      <p>
